(function ($, window, document, undefined) {
  ...
  function preloaderSvg() {
    if ($(".loader__svg pattern").length) {
      ...
      countLoader =
        countLoader < $(".loader__svg pattern").length ? countLoader + 1 : 1;
    }
  }
  ...
  function pageHeightCalculate() {
    if ($(".page-calculate.fullheight").length) {
      var pageCalculate = $(".page-calculate"),
        headerHeight =
          $(".header_top_bg").not(".header_trans-fixed").outerHeight() || 0,
  ...
  function submenuPosition() {
    if (
      ...
      var topH =
        ($("header.right-menu").outerHeight() -
          $("#topmenu > ul.menu").outerHeight()) /
          2 +
        $("#topmenu > ul.menu").outerHeight();
      $("header:not(.aside-menu).right-menu #topmenu ul .mega-menu > ul").css(
        "top",
        topH
      );
    } else if (
    ...
    if ($(".kenburns-wrap").length) {
      $(".kenburns-wrap").each(function () {
        var headerH =
          ...
          bottomplay = $("#footer").hasClass("fix-bottom")
            ? $("#footer").outerHeight() + 60
            : "30";
        $(this)
          .find(".kenburns-play")
          .css("bottom", bottomplay + "px");
        $(this)
          .find(".whizz-sound-btn")
          .css("bottom", bottomplay + "px");
        $(this).css("height", sliderH + "px");
        if ($(window).width() < 768 && _ismobile) {
          $(this)
            .find(".whizz-sound-btn")
            .css("bottom", bottomplay - 50 + "px");
          $(this)
            .find(".caption")
            .css("bottom", bottomplay + 10 + "px");
        } else {
          $(this)
            .find(".caption")
            .css("bottom", bottomplay - 20 + "px");
          $(this)
            .find(".whizz-sound-btn")
            .css("bottom", bottomplay + "px");
        }
  ...
  function topBannerHeight() {
    var headerH =
        $(".header_top_bg")
          .not(".header_trans-fixed, .fixed-header")
          .outerHeight() || 0,
      footerH = $("#footer").not(".fix-bottom").outerHeight() || 0,
    ...
    var minHban =
      $(".post-little-banner .main-top-content").height() + 100 > 300
    ...
    if ($(".top-banner.full-height-window .content").length) {
      ...
      if (windowH - headerH > contentB + 100) {
        $(".top-banner.full-height-window .content").css(
          "top",
          (windowH - headerH - contentB) / 2 + "px"
        );
      } else {
    ...
    $(".top-banner:not(.full-height-window) .content").css(
      "top",
      (bannerC - contentC) / 2 + 40 + "px"
    );
    if ($(window).width() < 992) {
    ...
    if ($(".iframe-video.banner-video").length) {
      ...
      if ($("#footer.no-footer").length) {
        $(".iframe-video.banner-video .fluid-width-video-wrapper").css(
          "height",
          bannerH + "px"
        );
        $(".iframe-video.banner-video ").css("height", bannerH + "px");
    ...
    $(".swiper-container").each(function () {
      ...
      swipers["swiper-" + index] = new Swiper(".swiper-" + index, {
        ...
        onInit: function (swiper) {
          ...
          if (
            $t.closest(".banner-slider-wrap.vertical") &&
            $(window).width() < 768
          ) {
      ...
      popup_image();
      $(".portfolio-slider-wrapper.slider_simple .info").on(
        "click",
        function () {
          var popup = $(this)
            .closest(".swiper-slide")
            .find(".caption-images-portfolio");
          $(".popup-portfolio-hidden").html(popup[0]);
          $(".popup-portfolio-hidden")
            .find(".caption-images-portfolio")
            .toggleClass("active");
          $(".popup-portfolio-hidden")
            .find(".images-one")
      ...
      $(".portfolio-slider-wrapper .close-btn").on("click", function () {
        ...
        if (
          $(".popup-portfolio-hidden").find(".caption-images-portfolio.active")
            .length
        ) {
          $(".header_top_bg").hide();
          $(".portfolio-pagination.slider_simple").hide();
            ...
            $t.find(".slider-click").each(function () {
              ...
              $(document).on("mousemove", function (event) {
                var arrow_parent = arrow.parent(),
                  parent_offset = arrow_parent.offset(),
                  pos_left = Math.min(
                    event.pageX - parent_offset.left,
                    arrow_parent.width()
                  ),
  ...
  $(".swiper3-outer-left").on("click", function () {
    swipers3[
      "swiper3-" + $(this).parent().find(".swiper3-container").attr("id")
    ].slidePrev();
  });
  ...
  $(".woocommerce-page.woocommerce-cart .woocommerce input.button").wrap(
    "<div class='shop-wrap'></div>"
  );
  $('.single-portfolio .protected-page input[type="submit"]').wrap(
    "<div class='input_protected_wrapper'></div>"
  );
  $('.events-single-content.protected-page input[type="submit"]').wrap(
    "<div class='input_protected_wrapper'></div>"
  );
  $('.main-wrapper .wpcf7 form input[type="submit"]').wrap(
    "<div class='input_protected_wrapper'></div>"
  );
  $('.single-product form .form-submit input[type="submit"]').wrap(
    "<div class='input_shop_wrapper'></div>"
  );
  $(
    '.single-post .comments-form form .input-wrapper input[type="submit"]'
  ).wrap("<div class='input_post_wrapper'></div>");
  ...
  let ytbg = $(".ytbg");
  if (ytbg.length) {
    $(".ytbg").YTPlayer({ showYTLogo: false, optimizeDisplay: true });
  }
  let equalHeight = $(".equal-height");
  if (equalHeight.length) {
    $('.equal-height [class*="col-"]').matchHeight({ byRow: false });
  }
  ...
  $(window).on("load", function () {
    ...
    if (blog.length) {
      $(".blog").imagesLoaded(function () {
        $(".blog").shuffle({ itemSelector: ".post" });
        setTimeout(function () {
  ...
  function portfolioColumns() {
    if ($(".portfolio.col-3").length) {
      $(
        ".item, .portfolio-pinterest .item-single, .palaroid .item-single, .adjusted .item-single"
      ).width(100 / 3 + "%");
    ...
    if ($(".single-portfolio .gallery-single.col-3").length) {
      $(".single-portfolio .gallery-single .item-single").css(
        "width",
        100 / 3 + "%"
      );
    }
  ...
  function portfolioSpace() {
    ...
    $(".portfolio[data-space]:not(.grid)").each(function () {
      ...
      if ($(this).hasClass("classic") && !$(this).hasClass("big")) {
        $(this)
          .find(".item")
          .css({ "margin-top": space, "margin-bottom": space - 30 });
        $(this)
          .find(".item-link")
          .css({ "margin-right": space, "margin-left": space });
      } else {
      ...
      if (
        ($(this).hasClass("big_gap") || $(this).hasClass("masonry")) &&
        !$(this).hasClass("masonry_modern")
      ) {
        $(this)
          .find(".item-link")
        ...
        $(this)
          .find(".item")
          .css({ "margin-top": space, "margin-bottom": space - 40 });
        if ($(this).hasClass("masonry")) {
          $(this).find(".item-link").css({ "margin-bottom": "7px" });
          $(this)
            .find(".item")
            .css({ "margin-top": space, "margin-bottom": space - 25 });
        }
      }
      if ($(this).hasClass("masonry_modern")) {
        $(this)
          ...
          .css({ width: "-webkit-calc(100% - " + space + "px)" });
        $(this)
          .find(".item")
          .css({ "margin-top": space / 2, "margin-bottom": space / 2 });
      }
      if ($(this).closest(".portfolio-wrapper").hasClass("palaroid")) {
        $(this).find(".item-link").css({ padding: space, margin: "0" });
      }
    });
    $(".portfolio.grid[data-space]").each(function () {
      ...
      if ($(this).hasClass("grid_modern")) {
        $(this)
          .find(".item")
          .css({ "margin-top": space - 15, "margin-bottom": space - 15 });
      }
      $(this)
        .find(".item-portfolio-content.grid_category")
        .css({
          width: "100%",
          "padding-right": space,
          "padding-left": space,
      ...
      $(this)
        .find(".item-portfolio-content:not(.grid_category, .grid_modern)")
        .css({
          "margin-right": space,
          "margin-left": space,
          "margin-bottom": space,
  ...
  if (
    $(".gallery-single").length ||
    $(".portfolio").length ||
    $(".pricing-gallery").length ||
    $(".line-wrap").length
  ) {
    $(".gallery-single, .portfolio, .pricing-gallery, .line-wrap").each(
      function () {
        var thumb =
          typeof $(this).attr("data-thumb") !== undefined &&
          typeof $(this).attr("data-thumb") !== false
  ...
  function initIsotop() {
    if ($(".izotope-container").length) {
      $(".izotope-container").each(function () {
        ...
        self.isotope({
          ...
          layoutMode: layoutM,
          masonry: { columnWidth: ".item-single", gutterWidth: 30 },
        });
      });
      if (
        $(".izotope-container")
          .closest(".portfolio-wrapper")
          .hasClass("portfolio-pinterest") ||
        $(".izotope-container")
          .closest(".portfolio-wrapper")
          .hasClass("adjusted")
      ) {
        $(".izotope-container")
          .closest(
            ".portfolio-wrapper.portfolio-pinterest, .portfolio-wrapper.adjusted"
          )
          .removeAttr("style");
      }
    }
    ...
    if ($(".insta-wrapper").length) {
      $(".insta-wrapper").each(function () {
        ...
        self.isotope({
          ...
          layoutMode: layoutM,
          masonry: { columnWidth: ".insta-item", gutterWidth: 0 },
        });
      });
    }
    if ($(".izotope-container-2").length) {
      $(".izotope-container-2").each(function () {
        ...
        self.isotope({
          ...
          layoutMode: layoutM,
          masonry: { columnWidth: ".full-single" },
        });
      });
    }
    ...
    if ($("#pixproof_gallery.masonry").length) {
      $("#pixproof_gallery.masonry").each(function () {
        ...
        self.isotope({
          ...
          layoutMode: layoutM,
          masonry: { columnWidth: ".proof-photo" },
        });
      });
    }
    if ($(".wpb_wrapper.shuffle").length) {
      $(".wpb_wrapper.shuffle").each(function () {
        ...
        self.isotope({
          itemSelector: ".item",
          layoutMode: "masonry",
          masonry: { columnWidth: ".item", horizontalOrder: true },
        });
      });
    }
    if ($(".pricing-gallery").length) {
      $(".pricing-gallery").each(function () {
        ...
        self.isotope({
          itemSelector: ".images",
          layoutMode: layoutM,
          masonry: { columnWidth: ".pricing-gallery .grid-sizer" },
        });
      });
    }
    if (
      $(".portfolio:not(.masonry) .wpb_wrapper, .blog").length &&
      ($(".portfolio:not(.masonry) .wpb_wrapper > .item").length ||
        $(".blog > .row > .item").length)
    ) {
      $(".portfolio:not(.masonry) .wpb_wrapper, .blog > .row").each(
        function () {
          var self = $(this);
          var layoutM = self.closest(".portfolio-wrapper").hasClass("palaroid")
            ? "fitRows"
            : "masonry";
    ...
    if (
      $(".portfolio.masonry .wpb_wrapper").length &&
      $(".portfolio.masonry .wpb_wrapper > .item").length
    ) {
  ...
  function calcPaddingMainWrapper() {
    ...
    if (
      !$("#footer.fix-bottom").length &&
      $("#footer.footer-parallax").length
    ) {
  ...
  function fixedMobileMenu() {
    ...
    if (
      $(".header_trans-fixed").length &&
      $(window).width() > 991 &&
      !$("body").hasClass("mob-main-menu")
    ) {
      var mt =
        ($("#topmenu > ul").outerHeight() -
          $("#topmenu .f-right").outerHeight()) /
        2;
  ...
  function load_infinite_scroll() {
    if (window.infinite_scroll) {
      var amount_images_per_page = parseInt(
        infinite_scroll.amount_images_per_page
      );
      ...
      $(window).on("scroll", function () {
        if (
          $(document).height() - winH == $(window).scrollTop() &&
          pageNum < maxPages
        ) {
          pageNum++;
          $.ajax({
            ...
            success: function (data) {
              var newElements = $(data).find(
                ".izotope-container-2 .item-single"
              );
              var elems = [];
              ...
              pageCalculations();
              if (
                $(".gallery-single, .portfolio, .pricing-gallery, .line-wrap")
                  .length
              ) {
                $(
                  ".gallery-single, .portfolio, .pricing-gallery, .line-wrap"
  ...
  function initMultiscroll() {
    ...
    if (mutiscrollWrapp.hasClass("fullheight")) {
      var headerHeight = $(".header_top_bg")
    ...
    if (
      (!mutiscrollWrapp.hasClass("albums-sp") && winW > 0 && winW < 480) ||
      (winW > 767 && winW < 992)
    ) {
  ...
  function portfolioFilter() {
    ...
    $(".albums-left-filter .filters-button-group").on(
      "click",
      "button",
      function () {
        var filterValue = $(this).attr("data-filter");
  ...
  function portfolioSliderHeight() {
    var headerH = $(".header_top_bg:not(.header_trans-fixed)").length
        ? $(".header_top_bg:not(.header_trans-fixed)").outerHeight()
        : 0,
      footerH = $("#footer:not(.fix-bottom)").length
        ? $("#footer:not(.fix-bottom)").outerHeight()
        : 0,
      sliderH = $(window).height() - (headerH + footerH);
    $(
    ...
    if ($(window).width() > 767) {
      $(".portfolio.grid .item.post-wrapper")
        .css("height", "auto")
        .equalHeights();
  ...
  portfolioSliderHeight();
  $(".popup-details").fancybox({ arrows: true, loop: true });
  $(".gallery-item.slip:not(.modern)")
    .parent()
    .parent()
    .sliphover({ caption: "data-content", target: ".info-content" });
  $(".gallery-item.slip.modern")
    .parent()
    .parent()
    .sliphover({ caption: "alt", target: ".gallery-item img", withLink: true });
  ...
  $(".portfolio-load-more").on("click", function () {
    var count = $(this).data("num"),
      counter = 0;
    $(this)
      .closest(".counter-wrap-port")
      .find(".item-single:not(.count-show)")
      .each(function () {
        if (counter < count) {
    ...
    if (
      !$(this)
        .closest(".counter-wrap-port")
        .find(".item-single:not(.count-show)").length
    ) {
      $(this).hide();
    }
    initIsotop();
  ...
  function initSwiper3() {
    ...
    $(".swiper3-container").each(function (index) {
      ...
      var slidesPerView = parseInt($t.attr("data-slidesPerView"), 10)
        ? parseInt($t.attr("data-slidesPerView"), 10)
        : "auto";
      var breakpoints = {};
      ...
      if ($t.hasClass("showcase_slider")) {
        breakpoints = { 767: { slidesPerView: 1 }, 991: { slidesPerView: 2 } };
      }
      swipers3["swiper3-" + index] = new Swiper3($t, {
        ...
        containerModifierClass: "swiper3-container-",
        ...
        paginationClickableClass: "swiper3-pagination-clickable",
        paginationModifierClass: "swiper3-pagination-",
  ...
  function changeBg() {
    if (
      $(".swiper-container-vert-slider .swiper-slide-active").attr("data-bg")
    ) {
      var colorBg = $(
        ".swiper-container-vert-slider .swiper-slide-active"
      ).attr("data-bg");
      $(".outer-swiper-wrapper .img-overlay").css(
        "background-image",
        "url(" + colorBg + ")"
      );
    } else {
      var colorBg = $(".swiper-container-vert-slider .swiper-slide-active").css(
        "background-image"
      );
  ...
  function heightVerticalSlider() {
    ...
    $(".swiper-container-vert-slider").css(
      "height",
  ...
  $(window).on("load resize", function () {
    if ($(".pinterest.item-single a").length) {
      $(".pinterest.item-single a")
        .not(".animated")
        .each(function () {
          if (
            $(window).scrollTop() >=
            $(this).offset().top - $(window).height() * 0.8
          ) {
            $(this).addClass("animated fadeInUp");
          }
        });
  ...
  playVideoOnMobile();
  $(".iframe-video:not(.for-btn) .video-close-button").css(
    "top",
    $("header").height() + 10
  );
  ...
  function asideMenuStatic() {
    if (
      ...
      $("#topmenu ul.menu").css({ "max-height": maxHeight });
      ...
      $("#topmenu ul.menu").css({ "max-height": maxH });
    }
  }
  $(window).on("resize", function () {
    asideMenuStatic();
  ...
  $(window).on("load", function () {
    if ($(".mini_cart_item_thumbnail img").length) {
      var fixLazyImg = setInterval(function () {
        if (
          $(".mini_cart_item_thumbnail img").attr("src") ==
              ...
              $item.each(function () {
                $(this).on("mouseenter mouseleave", function (e) {
                  var $this = $(this),
                    ...
                    height = $this.height();
                  var x =
                      (e.pageX - $this.offset().left - width / 2) *
                      (width > height ? height / width : 1),
                    y =
                      (e.pageY - $this.offset().top - height / 2) *
